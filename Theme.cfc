...
component{
	// Layout Variables
    this.name       	= "Fitness";
	this.description 	= "Fitness is a free responsive Bootstrap themes from templatemo and use them for your sites";
	this.version		= "1.0.0";
	...
	this.settings = [
		...
		{ name="googlePlusUrl", 	group="Social Share Options", defaultValue="", type="text",	label="google plus share url", 	required="false" },
